...
const create = async (data) => {
	...
	if(mentor.status != 200)
    	return {code : 400, message : `Error al crear al docente`, error: mentor.data.message};
...
const getById = async (id) => {
	...
	if(mentor.status != 200)
    	return {code : 400, message : `Error al obtener al docente con el id: ${id}`, error: mentor.data.message};
